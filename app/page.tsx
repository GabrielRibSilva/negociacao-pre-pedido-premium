    ...
    <section id="experiencia" className="bg-slate-50 py-10">
      <div className="mx-auto max-w-6xl px-6 text-center">
        ...
        <p className="mx-auto mt-5 max-w-6xl text-lg leading-8 text-slate-500">
          Mais do que registrar informações, o Módulo Negociação transforma a apresentação da venda.
      ...
      <main>
        ...
        <section className="relative overflow-hidden bg-transparent py-12">
          ...
          <div className="mx-auto max-w-5xl px-6">
            <img
              src="https://www.dropbox.com/scl/fi/p2tepmlfa6amhahh698ug/Apresenta-o-fluxo-antigo-x-novo-com-setas-3-em-1.png?rlkey=g3p0cj8bmfr624nug77jqi6s3&st=3fc8oug4&raw=1"
