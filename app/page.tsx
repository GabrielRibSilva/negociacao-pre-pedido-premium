    ...
    <section className="relative overflow-hidden bg-white">
      ...
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 px-6 py-16 lg:grid-cols-[0.88fr_1.12fr] lg:py-20">
        <div>
          ...
          <p className="mt-4 max-w-5xl text-lg leading-8 text-slate-500">
  ...
  return (
    <section id="experiencia" className="bg-slate-50 py-12">
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        <h2 className="mx-auto mt-3 max-w-4xl text-3xl font-black tracking-tight text-slate-950 md:text-5xl lg:text-6xl">
          Uma tela feita para encantar.
        </h2>

        <p className="mx-auto mt-5 max-w-4xl text-lg leading-8 text-slate-500">
        ...
        <div className="mt-8 flex justify-center">
          <div className="w-[82%] overflow-hidden rounded-[1.5rem] border border-slate-200 bg-white shadow-xl shadow-slate-950/10">
            <img
              src="https://www.dropbox.com/scl/fi/owtnxa4glajonj3yich1y/imagem-NEGOCIA-O-MOBATO-2.png?rlkey=5spjm39vw0tqglayl3mqn7d49&raw=1"
  ...
  return (
    <section id="valor" className="overflow-hidden bg-white py-16">
      ...
      <div className="mx-auto max-w-7xl px-6 text-center">
        ...
        <p className="mx-auto mt-5 max-w-6xl text-lg leading-8 text-slate-500">
  ...
  return (
    <section id="demo" className="bg-slate-50 py-12">
      <div className="mx-auto max-w-7xl px-8 text-center">
        ...
        <p className="mx-auto mt-5 max-w-5xl text-lg leading-8 text-slate-500">
  ...
  return (
    <footer className="bg-slate-950 px-6 py-16 text-white">
      <div className="mx-auto max-w-7xl rounded-[2.5rem] bg-gradient-to-br from-blue-600 to-blue-700 p-10 text-center shadow-2xl md:p-16">
        ...
        <p className="mx-auto mt-7 max-w-6xl text-lg leading-8 text-blue-100">
